...
$rocket_path        = '/data/sites/web/amarenobe/www/wp-content/plugins/wp-rocket/';
$rocket_config_path = '/data/sites/web/amarenobe/www/wp-content/wp-rocket-config/';
$rocket_cache_path  = '/data/sites/web/amarenobe/www/wp-content/cache/wp-rocket/';
...
if ( file_exists( '/data/sites/web/amarenobe/www/wp-content/plugins/wp-rocket/inc/classes/dependencies/mobiledetect/mobiledetectlib/Mobile_Detect.php' ) && ! class_exists( 'WP_Rocket_Mobile_Detect' ) ) {
	include_once '/data/sites/web/amarenobe/www/wp-content/plugins/wp-rocket/inc/classes/dependencies/mobiledetect/mobiledetectlib/Mobile_Detect.php';
}
