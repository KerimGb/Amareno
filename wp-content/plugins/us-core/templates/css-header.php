...
<?php foreach ( array( 'top', 'middle', 'bottom' ) as $area ) :
	...
	.no-touch .l-header.bg_transparent:not(.sticky) .at_<?= $area ?> .w-socials.color_text a:hover,
	.no-touch .l-header.bg_transparent:not(.sticky) .at_<?= $area ?> .w-socials.color_link a:hover,
