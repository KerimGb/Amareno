...
if ( ! defined( 'ULTIMATE_VERSION' ) ) {
	define( 'ULTIMATE_VERSION', '3.20.2' );
}
					...
					'bsf' => array(
						...
						'deactivation_survey' => array(
							array(
								...
								'popup_title'       => __( 'Quick Feedback', 'ultimate_vc' ),
								'support_url'       => 'https://ultimate.brainstormforce.com/support/',
								'popup_description' => __( 'If you have a moment, please share why you are deactivating Ultimate Addons for WPBakery Page Builder:', 'ultimate_vc' ),
